...
function PageHero({ title, description, image, eyebrow = 'Valuelink Technologies' }) {
  return (
    <section className="px-4 pb-8 pt-6 sm:pb-12">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[36px] border border-slate-200/60 bg-white shadow-soft dark:border-white/10 dark:bg-white/[0.04]">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
          <div className="relative overflow-hidden bg-[linear-gradient(135deg,#0a1929_0%,#1e3a5f_65%,#245f79_100%)] px-6 py-16 text-white sm:px-10 lg:px-14">
            ...
            <div className="absolute -right-16 top-10 h-44 w-44 rounded-full bg-teal/20 blur-3xl" />
          ...
          <div className="relative min-h-[280px] bg-slate-100 dark:bg-slate-900">
            <SmartImage
              src={image}
              alt={title}
              priority
