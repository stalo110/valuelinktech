    ...
    <>
      ...
      <AnimatedSection className="px-4 py-8 sm:py-12">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[32px] border border-[color:var(--surface-border)] bg-[linear-gradient(135deg,#15100f_0%,#35201b_60%,#8d2418_100%)] p-8 text-white shadow-soft sm:p-10">
            <SectionHeading
          ...
          <div className="section-shell">
            ...
            <div className="mt-6 space-y-4">
              {coreOffers.map((item, index) => (
                <AnimatedSection key={item} as="div" delay={index * 0.04} amount={0.1} className="flex gap-3 rounded-2xl bg-[#fbf3eb] p-4 dark:bg-white/[0.04]">
                  <CheckCircle2 className="mt-1 h-5 w-5 shrink-0 text-ember dark:text-sand" />
                  <span className="text-sm leading-7 text-stone-700 dark:text-stone-200">{item}</span>
                </AnimatedSection>
              ))}
            </div>
          </div>
      ...
      <AnimatedSection className="px-4 pb-14 pt-8 sm:pt-12">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[36px] border border-[color:var(--surface-border)] bg-[color:var(--surface-bg-strong)] shadow-card lg:grid lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative min-h-[280px]">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(21,16,15,0.14),rgba(21,16,15,0.56))]" />
          </div>
          <div className="p-8 sm:p-10 lg:p-12">
            ...
            />
            <div className="mt-8 rounded-[28px] border border-[color:var(--surface-border)] bg-[#fbf3eb] p-6 text-sm leading-7 text-[color:var(--muted-text)] dark:bg-white/[0.04]">
